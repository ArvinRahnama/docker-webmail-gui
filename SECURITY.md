...
| #   | Check                                                       | Lives in                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --- | ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Injection payloads, every command builder                   | `apps/server/src/drivers/dms/commands.test.ts` (pre-existing sweep) + `apps/server/src/security/command-injection.security.test.ts` (exhaustiveness manifest against `commands.ts`'s real exports, plus the gaps that manifest found: `buildAliasDeleteCommand`'s recipient, the six `doveadm sieve`/quota builders)                                                                                                                                                                                                                          |
