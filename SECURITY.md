...
| 8   | Log redaction                                               | `apps/server/src/platform/logger.test.ts` (mechanism, pre-existing) + `apps/server/src/security/log-redaction.security.test.ts` (end-to-end: the real app, a real login/change-password sequence, the raw captured log text)                                                                                                                                                                                                                                                                                                                  |
